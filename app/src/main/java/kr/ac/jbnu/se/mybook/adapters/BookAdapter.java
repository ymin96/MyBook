...
public class BookAdapter extends ArrayAdapter<Book> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            viewHolder.tvPublisher = (TextView)convertView.findViewById(R.id.tvPublisher);
        ...
        viewHolder.tvPublisher.setText(book.getPublisher());
        viewHolder.tvSalePrice.setText(String.valueOf((book.getSalePrice())));
